export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx6f69d9aadeb82749",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "e81a245a3d0a3f208cca99b9da198b25",
  ...
  USERS: [
    {
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "陈小姐", "year": "1999", "date": "09-09"},
  ...
  FESTIVALS: [
    // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
    {"type": "*生日", "name": "宝贝", "year": "1999", "date": "09-09", isShowAge: true},
